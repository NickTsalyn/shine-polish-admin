...
export default function PhotoForm({onClose}: Props) {
 ...
 const handleSubmit = async (event: React.FormEvent) => {
  ...
  try {
   ...
   enqueueSnackbar("Error adding photos", {variant: "error"});
  }
 };
 ...
 const handleDelete = async (id: string) => {
  try {
   ...
   enqueueSnackbar("Error deleting photos", {variant: "error"});
  }
 };
 ...
 return (
  <div className="flex flex-col gap-4 md:gap-6 ">
   <h2 className="text-accent text-2xl md:text-4xl lg:text-5xl text-center">Upload Photos</h2>
   <form
